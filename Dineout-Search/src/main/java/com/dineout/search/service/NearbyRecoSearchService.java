...
@Service("nearbyRecoSearchService")
public class NearbyRecoSearchService implements RecoSearchService{
	Logger logger = Logger.getLogger(NearbyRecoSearchService.class);
	@Autowired
